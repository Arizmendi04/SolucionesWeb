...
<html lang="es">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="titulosLabel formulario">
                    ...
                    <form action="/SolucionesWeb/Static/Controller/ControllerEmpleado/Productos.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="product-list">
                            ...
                            foreach ($productos as $producto) {
                                ...
                                <div class='product-card'>
                                    ...
                                    <a href=\"/SolucionesWeb/Static/Controller/ControllerEmpleado/AgregarAlCarrito.php?folio=" . $producto['folio'] . "&cantidad=1\"class=\"btn btn-sm\" id=\"agregarCarrito\">
        ...
        <div id="mensajeExito" class="alert alert-success" name="mensajeExito" style="display: none;">
            <a href="/SolucionesWeb/Static/View/Empleado/ViewGestionVent.php">
