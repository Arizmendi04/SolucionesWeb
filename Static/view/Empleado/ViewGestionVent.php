...
<body>
    <div class="container">
                        ...
                        if ($resultVentas && $resultVentas->num_rows > 0) {
                            while ($venta = $resultVentas->fetch_assoc()) {
                                echo "<tr>
                                    ...
                                    <td>$ {$venta['total']}</td>
                                    <td>
                                        <a href='/SolucionesWeb/Static/View/Empleado/VentaProducto.php?accion=editar&id={$venta['idVenta']}' class='btn btn-primary'>Editar</a>
        ...
        <div class="botones-container">
            <div align="center">
                <a href="/SolucionesWeb/Static/View/Empleado/ViewGestionTickets.php">
                    <button class="btn btn-fin">Consultar tickets</button>
                </a>
            </div>
            <div align="center">
            <form method="POST" action="/SolucionesWeb/Static/Controller/ControllerEmpleado/Tickets.php">
    ...
    <script>
        ...
        function enviarDatos(event, inputElement, folioProd, cantidad, precio) {
            ...
            xhr.open('POST', '/SolucionesWeb/Static/Controller/ControllerEmpleado/Ventas.php', true);
