    ...
    <body>
                ...
                <div class="tabla">
                    ...
                    <table id="tablaVentas" class="table table-striped">
                        ...
                        <tbody id="resultadosVentas">
                            <?php include '../../Controller/ControllerEmpleado/Tickets.php'; ?>
                        </tbody>
                    </table>
                </div>
        ...
        <script>
            function filtrarVentas(fecha) {
                ...
                const url = fecha ? `/SolucionesWeb/Static/Controller/ControllerEmpleado/Tickets.php?accion=filtrar&fecha=${fecha}` : `/SolucionesWeb/Static/Controller/ControllerEmpleado/Tickets.php?accion=filtrar`;
